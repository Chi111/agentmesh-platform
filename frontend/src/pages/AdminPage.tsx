...
const roleMeta: Record<UserProfile['role'], { label: string; tone: StatusTone }> = {
  requester: { label: '任务方', tone: 'info' },
  developer: { label: '开发者', tone: 'success' },
  admin: { label: '管理员', tone: 'neutral' },
};
